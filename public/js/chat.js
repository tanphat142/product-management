...
const showTyping = () => {
  ...
  //moi lan go la clear timeout(lan dau ch co nen ch clear sau do no sẽ clear trc 3s)
...
if (emojiPicker) {
  ...
  emojiPicker.addEventListener("emoji-click", (event) => {
    ...
    // dùng để focus vào vị trí cuối ô input khi chèn icon hoặc blur ra ngoài khi giá trị ô input quá dài
